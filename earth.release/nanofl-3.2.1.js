...
nanofl_engine_libraryitems_MovieClipItem2D.prototype = $extend(nanofl_engine_libraryitems_InstancableItem2D.prototype,{
	...
	,updateDisplayObject: function(dispObj,childFrameIndexes) {
		if(!this.exportAsSpriteSheet) {
			stdlib_Debug.assert(js_Boot.__instanceof(dispObj,nanofl_MovieClip),null,{ fileName : "MovieClipItem2D.hx", lineNumber : 184, className : "nanofl.engine.libraryitems.MovieClipItem2D", methodName : "updateDisplayObject"});
