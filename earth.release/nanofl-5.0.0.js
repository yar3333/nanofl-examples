...
var js_npm_DrFontSupport = __webpack_require__(1);
...
$hxClasses["nanofl.IInstance"] = nanofl_IInstance;
...
var nanofl_MovieClip = $hx_exports["nanofl"]["MovieClip"] = function(symbol,initFrameIndex,childFrameIndexes) {
	...
	stdlib_Debug.assert(js_Boot.__instanceof(symbol,nanofl_engine_libraryitems_MovieClipItem2D),null,{ fileName : "MovieClip.hx", lineNumber : 29, className : "nanofl.MovieClip", methodName : "new"});
		...
		while(_g1 < _g) {
			...
			if(oldFrame != null && newFrame != null && oldFrame.keyFrame == newFrame.keyFrame) {
				if(newFrame.keyFrame.get_motionTween() != null) {
					...
					stdlib_Debug.assert(tweenedElements.length == layerChildren.length,"tweenedElements.length=" + tweenedElements.length + " != layerChildren.length=" + layerChildren.length,{ fileName : "MovieClip.hx", lineNumber : 233, className : "nanofl.MovieClip", methodName : "gotoFrame"});
					var _g3 = 0;
					...
					while(_g3 < _g2) {
						...
						if(js_Boot.__instanceof(tweenedElements[i1].current,nanofl_MovieClip) || js_Boot.__instanceof(tweenedElements[i1].current,createjs.Sprite)) {
	...
	,advance: function() {
		...
		if(childrenToAdvance == null) {
			...
			while(_g < _g1.length) {
				var child = _g1[_g];
				++_g;
				if(js_Boot.__instanceof(child,nanofl_MovieClip)) {
					child.advance();
...
nanofl_DisplayObjectTools.smartUncache = function(obj) {
	...
	while(obj != null) {
		...
		if(js_Boot.__instanceof(obj,nanofl_MovieClip) && inspiredByChild != null) {
...
nanofl_DisplayObjectTools.getOuterBounds = function(obj,ignoreSelf) {
	...
	if(js_Boot.__instanceof(obj,createjs.Container) && !js_Boot.__instanceof(obj,nanofl_SolidContainer)) {
		...
		while(_g < _g1.length) {
			var child = _g1[_g];
			++_g;
			var b = nanofl_engine_geom2D_BoundsTools.transform(nanofl_DisplayObjectTools.getOuterBounds(child),child.getMatrix());
			if(b != null) {
				if(r != null) {
					r = r.union(b);
				} else {
...
nanofl_DisplayObjectTools.getInnerBounds = function(obj) {
	...
	if(js_Boot.__instanceof(obj,createjs.Container) && !js_Boot.__instanceof(obj,nanofl_SolidContainer)) {
		...
		while(_g < _g1.length) {
			var child = _g1[_g];
			++_g;
			var b = nanofl_engine_geom2D_BoundsTools.transform(nanofl_DisplayObjectTools.getInnerBounds(child),child.getMatrix());
			if(b != null) {
				if(r != null) {
					r = r.union(b);
				} else {
...
nanofl_DisplayObjectTools.dump = function(obj,level) {
	...
	if(js_Boot.__instanceof(obj,nanofl_MovieClip)) {
...
$hxClasses["nanofl.InstanceTools"] = nanofl_InstanceTools;
...
nanofl_InstanceTools.bindEventHandlers = function(instance) {
	...
	var tmp = function(e) {
		nanofl_InstanceTools.stageMouseEventProxy(a1,f,e);
	};
...
nanofl_TextField.prototype = $extend(nanofl_SolidContainer.prototype,{
	...
	,set_text: function(v) {
		var format = this.textRuns.length > 0 ? this.textRuns[this.textRuns.length - 1] : this.get_newTextFormat();
	...
	,getTextLines: function() {
		...
		while(_g1 < _g) {
			...
			while(_g31 < _g21) {
				...
				stdlib_Debug.assert(run2.letterSpacing != null,null,{ fileName : "TextField.hx", lineNumber : 292, className : "nanofl.TextField", methodName : "getTextLines"});
				...
				stdlib_Debug.assert(run2.lineSpacing != null,null,{ fileName : "TextField.hx", lineNumber : 310, className : "nanofl.TextField", methodName : "getTextLines"});
				if(lineSpacing != null) {
...
var nanofl_engine_FilterDef2D = function(name,params) {
	stdlib_Debug.assert(params != null,null,{ fileName : "FilterDef2D.hx", lineNumber : 27, className : "nanofl.engine.FilterDef2D", methodName : "new"});
	this.name = name;
	this._params = params;
};
...
nanofl_engine_FilterDef2D.prototype = {
	...
	,tween: function(t,finish) {
		stdlib_Debug.assert(finish == null || this.name == finish.name,this.name + " != " + finish.name,{ fileName : "FilterDef2D.hx", lineNumber : 99, className : "nanofl.engine.FilterDef2D", methodName : "tween"});
		var tmp;
		if(t != 0.0) {
			var key = this.name;
			var _this = nanofl_engine_plugins_FilterPlugins2D.plugins;
...
var nanofl_engine_FilterDef3D = function(name,params) {
	stdlib_Debug.assert(params != null,null,{ fileName : "FilterDef3D.hx", lineNumber : 27, className : "nanofl.engine.FilterDef3D", methodName : "new"});
	this.name = name;
	this._params = params;
};
...
nanofl_engine_FilterDef3D.prototype = {
	...
	,tween: function(t,finish) {
		stdlib_Debug.assert(finish == null || this.name == finish.name,this.name + " != " + finish.name,{ fileName : "FilterDef3D.hx", lineNumber : 82, className : "nanofl.engine.FilterDef3D", methodName : "tween"});
		var tmp;
		if(t != 0.0) {
			var key = this.name;
			var _this = nanofl_engine_plugins_FilterPlugins3D.plugins;
...
nanofl_engine_Library.prototype = {
	...
	,getItem: function(namePath) {
		stdlib_Debug.assert(namePath != null,null,{ fileName : "Library.hx", lineNumber : 129, className : "nanofl.engine.Library", methodName : "getItem"});
		stdlib_Debug.assert(namePath != "",null,{ fileName : "Library.hx", lineNumber : 130, className : "nanofl.engine.Library", methodName : "getItem"});
		var _this = this.items;
		var r = __map_reserved[namePath] != null ? _this.getReserved(namePath) : _this.h[namePath];
		if(r != null) {
			return r;
		}
		haxe_Log.trace("Symbol '" + namePath + "' is not found.",{ fileName : "Library.hx", lineNumber : 133, className : "nanofl.engine.Library", methodName : "getItem"});
	...
	,preload: function() {
		...
		if(loadCount > 0) {
			...
			while(item.hasNext()) {
				var item1 = item.next();
				var item2 = [item1];
				r = r.then((function(item3) {
					return function(_) {
						return item3[0].preload();
					};
				})(item2));
			}
			return r;
...
nanofl_engine_Loader.queued = function(urls,load) {
	return Promise.all(urls.map(function(_) {
		return load(_);
	}));
};
...
nanofl_engine_libraryitems_LibraryItem.prototype = {
	...
	,equ: function(item) {
		return stdlib_Debug.methodMustBeOverriden(this,{ fileName : "LibraryItem.hx", lineNumber : 118, className : "nanofl.engine.libraryitems.LibraryItem", methodName : "equ"});
	}
	,toString: function() {
...
nanofl_engine_base_BaseInstancableItem.prototype = $extend(nanofl_engine_libraryitems_LibraryItem.prototype,{
	...
	,newInstance: function() {
		stdlib_Debug.assert(this.library != null,"You must add symbol '" + this.namePath + "' to library before newInstance() call.",{ fileName : "BaseInstancableItem.hx", lineNumber : 48, className : "nanofl.engine.base.BaseInstancableItem", methodName : "newInstance"});
		...
		if(finishElements != null) {
			...
			while(startElement.hasNext()) {
				...
				if(this.isInstance(startElement1) && instancesMap.h.__keys__[startElement1.__id__] != null) {
					...
					stdlib_Debug.assert(startFilters.length == finishFilters.length,"startFilters.length = " + startFilters.length + " != finishFilters.length = " + finishFilters.length,{ fileName : "BaseMotionTween.hx", lineNumber : 83, className : "nanofl.engine.base.BaseMotionTween", methodName : "apply"});
...
nanofl_engine_coloreffects_ColorEffect.load = function(node) {
	if(node != null) {
		stdlib_Debug.assert(node.name == "color",node.name,{ fileName : "ColorEffect.hx", lineNumber : 42, className : "nanofl.engine.coloreffects.ColorEffect", methodName : "load"});
...
nanofl_engine_coloreffects_ColorEffect.prototype = {
	...
	,save: function(out) {
		stdlib_Debug.methodMustBeOverriden(this,{ fileName : "ColorEffect.hx", lineNumber : 54, className : "nanofl.engine.coloreffects.ColorEffect", methodName : "save"});
	}
	,equ: function(c) {
		return stdlib_Debug.methodMustBeOverriden(this,{ fileName : "ColorEffect.hx", lineNumber : 56, className : "nanofl.engine.coloreffects.ColorEffect", methodName : "equ"});
	}
...
nanofl_engine_coloreffects_ColorEffectAdvanced.prototype = $extend(nanofl_engine_coloreffects_ColorEffect.prototype,{
	...
	,getTweened: function(k,finish) {
		stdlib_Debug.assert(js_Boot.__instanceof(finish,nanofl_engine_coloreffects_ColorEffectAdvanced),null,{ fileName : "ColorEffectAdvanced.hx", lineNumber : 90, className : "nanofl.engine.coloreffects.ColorEffectAdvanced", methodName : "getTweened"});
...
nanofl_engine_elements2D_Element.prototype = $extend(nanofl_engine_base_BaseElement.prototype,{
	...
	,createDisplayObject: function(frameIndexes) {
		return stdlib_Debug.methodMustBeOverriden(this,{ fileName : "Element.hx", lineNumber : 81, className : "nanofl.engine.elements2D.Element", methodName : "createDisplayObject"});
	}
	,updateDisplayObject: function(dispObj,frameIndexes) {
		return stdlib_Debug.methodMustBeOverriden(this,{ fileName : "Element.hx", lineNumber : 83, className : "nanofl.engine.elements2D.Element", methodName : "updateDisplayObject"});
	}
...
nanofl_engine_elements2D_GroupElement.prototype = $extend(nanofl_engine_elements2D_Element.prototype,{
	...
	,updateDisplayObject: function(dispObj,frameIndexes) {
		stdlib_Debug.assert(js_Boot.__instanceof(dispObj,createjs.Container),this.toString(),{ fileName : "GroupElement.hx", lineNumber : 118, className : "nanofl.engine.elements2D.GroupElement", methodName : "updateDisplayObject"});
		stdlib_Debug.assert(this.get_elements().length > 0,this.toString(),{ fileName : "GroupElement.hx", lineNumber : 119, className : "nanofl.engine.elements2D.GroupElement", methodName : "updateDisplayObject"});
...
nanofl_engine_elements2D_ShapeElement.prototype = $extend(nanofl_engine_elements2D_Element.prototype,{
	...
	,updateDisplayObject: function(dispObj,frameIndexes) {
		stdlib_Debug.assert(js_Boot.__instanceof(dispObj,createjs.Shape),null,{ fileName : "ShapeElement.hx", lineNumber : 196, className : "nanofl.engine.elements2D.ShapeElement", methodName : "updateDisplayObject"});
		this.updateDisplayObjectProperties(dispObj);
		var shape = dispObj;
	...
	,findOrCreatePolygonByPoint: function(x,y,fill) {
		...
		stdlib_Debug.assert(!nanofl_engine_geom2D_Edges.hasDuplicates(allEdges),allEdges.toString(),{ fileName : "ShapeElement.hx", lineNumber : 728, className : "nanofl.engine.elements2D.ShapeElement", methodName : "findOrCreatePolygonByPoint"});
		...
		stdlib_Debug.assert(outer.isClockwise(),null,{ fileName : "ShapeElement.hx", lineNumber : 782, className : "nanofl.engine.elements2D.ShapeElement", methodName : "findOrCreatePolygonByPoint"});
		...
		while(_g1 < inners.length) {
			...
			++_g1;
			inner.reverse();
			stdlib_Debug.assert(inner.isCounterClockwise(),null,{ fileName : "ShapeElement.hx", lineNumber : 789, className : "nanofl.engine.elements2D.ShapeElement", methodName : "findOrCreatePolygonByPoint"});
	...
	,getEdges: function() {
		...
		stdlib_Debug.assert(!nanofl_engine_geom2D_Edges.hasDuplicates(r),null,{ fileName : "ShapeElement.hx", lineNumber : 1021, className : "nanofl.engine.elements2D.ShapeElement", methodName : "getEdges"});
		return r;
	}
	,replaceEdge: function(search,replacement) {
		nanofl_engine_geom2D_StrokeEdges.replace(this.edges,search,replacement);
		stdlib_Debug.assert(search.indexIn(this.edges) < 0,"\nsearch = " + Std.string(search) + "\nreplacement = " + Std.string(replacement),{ fileName : "ShapeElement.hx", lineNumber : 1028, className : "nanofl.engine.elements2D.ShapeElement", methodName : "replaceEdge"});
		var _g = 0;
		var _g1 = this.polygons;
		while(_g < _g1.length) {
			var p = _g1[_g];
			...
			stdlib_Debug.assert(search.indexIn(p.getEdges()) < 0,"\nsearch = " + Std.string(search) + "\nreplacement = " + Std.string(replacement),{ fileName : "ShapeElement.hx", lineNumber : 1033, className : "nanofl.engine.elements2D.ShapeElement", methodName : "replaceEdge"});
		}
		stdlib_Debug.assert(search.indexIn(this.getEdges()) < 0,"\nsearch = " + Std.string(search) + "\nreplacement = " + Std.string(replacement),{ fileName : "ShapeElement.hx", lineNumber : 1036, className : "nanofl.engine.elements2D.ShapeElement", methodName : "replaceEdge"});
	}
	,normalize: function() {
...
nanofl_engine_elements2D_TextElement.prototype = $extend(nanofl_engine_elements2D_Element.prototype,{
	...
	,updateDisplayObject: function(dispObj,frameIndexes) {
		stdlib_Debug.assert(js_Boot.__instanceof(dispObj,nanofl_TextField),null,{ fileName : "TextElement.hx", lineNumber : 139, className : "nanofl.engine.elements2D.TextElement", methodName : "updateDisplayObject"});
		this.updateDisplayObjectProperties(dispObj);
		var tf = dispObj;
	...
	,getMinSize: function(dispObj) {
		stdlib_Debug.assert(js_Boot.__instanceof(dispObj,nanofl_TextField),null,{ fileName : "TextElement.hx", lineNumber : 163, className : "nanofl.engine.elements2D.TextElement", methodName : "getMinSize"});
...
nanofl_engine_elements2D_ThreeViewElement.prototype = $extend(nanofl_engine_elements2D_Element.prototype,{
	...
	,updateDisplayObject: function(dispObj,frameIndexes) {
		stdlib_Debug.assert(js_Boot.__instanceof(dispObj,nanofl_ThreeView),null,{ fileName : "ThreeViewElement.hx", lineNumber : 96, className : "nanofl.engine.elements2D.ThreeViewElement", methodName : "updateDisplayObject"});
		this.updateDisplayObjectProperties(dispObj);
		var view = dispObj;
...
nanofl_engine_elements3D_Element3D.prototype = $extend(nanofl_engine_base_BaseElement.prototype,{
	...
	,createDisplayObject: function(frameIndexes) {
		return stdlib_Debug.methodMustBeOverriden(this,{ fileName : "Element3D.hx", lineNumber : 70, className : "nanofl.engine.elements3D.Element3D", methodName : "createDisplayObject"});
	}
	,updateDisplayObject: function(dispObj,frameIndexes) {
		return stdlib_Debug.methodMustBeOverriden(this,{ fileName : "Element3D.hx", lineNumber : 72, className : "nanofl.engine.elements3D.Element3D", methodName : "updateDisplayObject"});
	}
	,updateDisplayObjectProperties: function(dispObj) {
	}
	,transform: function(m,applyToStrokeAndFill) {
...
nanofl_engine_geom2D_Polygon.prototype = {
	...
	,isEdgeInside: function(edge) {
		stdlib_Debug.assert(this.contours.length > 0,null,{ fileName : "Polygon.hx", lineNumber : 113, className : "nanofl.engine.geom2D.Polygon", methodName : "isEdgeInside"});
	...
	,isPolygonInside: function(p) {
		stdlib_Debug.assert(this.contours.length > 0,null,{ fileName : "Polygon.hx", lineNumber : 127, className : "nanofl.engine.geom2D.Polygon", methodName : "isPolygonInside"});
		stdlib_Debug.assert(p.contours.length > 0,null,{ fileName : "Polygon.hx", lineNumber : 128, className : "nanofl.engine.geom2D.Polygon", methodName : "isPolygonInside"});
		var _g = 0;
	...
	,getPointInside: function() {
		...
		while(_g3 < _g12.length) {
			...
			stdlib_Debug.assert(xx.length % 2 == 0,"Polygon.getPointInside() error\nxx = " + Std.string(xx) + "\nrY = " + rY + "\nedges = " + Std.string(contour.edges),{ fileName : "Polygon.hx", lineNumber : 332, className : "nanofl.engine.geom2D.Polygon", methodName : "getPointInside"});
		}
...
nanofl_engine_geom2D_StrokeEdges.duplicateStrokes = function(edges) {
	var processed = new haxe_ds_ObjectMap();
	var _g = 0;
	while(_g < edges.length) {
		var e = edges[_g];
...
nanofl_engine_libraryitems_InstancableItem2D.prototype = $extend(nanofl_engine_base_BaseInstancableItem.prototype,{
	...
	,createDisplayObject: function(initFrameIndex,childFrameIndexes) {
		if(this.linkedClass != "") {
			...
			haxe_Log.trace("Linkage class '" + this.linkedClass + "' is not found.",{ fileName : "InstancableItem2D.hx", lineNumber : 24, className : "nanofl.engine.libraryitems.InstancableItem2D", methodName : "createDisplayObject"});
		}
		return null;
	}
	,updateDisplayObject: function(dispObj,childFrameIndexes) {
		stdlib_Debug.methodMustBeOverriden(this,{ fileName : "InstancableItem2D.hx", lineNumber : 30, className : "nanofl.engine.libraryitems.InstancableItem2D", methodName : "updateDisplayObject"});
	}
	,getNearestPoint: function(pos) {
		return { x : 1e100, y : 1e100};
	}
...
nanofl_engine_libraryitems_BitmapItem.prototype = $extend(nanofl_engine_libraryitems_InstancableItem2D.prototype,{
	...
	,preload: function() {
		var _gthis = this;
		stdlib_Debug.assert(this.library != null,"You need to add item '" + this.namePath + "' to the library before preload call.",{ fileName : "BitmapItem.hx", lineNumber : 115, className : "nanofl.engine.libraryitems.BitmapItem", methodName : "preload"});
		if(nanofl_engine_TextureItemTools.getSpriteSheet(this) == null) {
			return nanofl_engine_Loader.image(this.getUrl()).then(function(i) {
				_gthis.image = i;
				return null;
			});
		} else {
	...
	,updateDisplayObject: function(dispObj,childFrameIndexes) {
		stdlib_Debug.assert(js_Boot.__instanceof(dispObj,createjs.Bitmap),null,{ fileName : "BitmapItem.hx", lineNumber : 152, className : "nanofl.engine.libraryitems.BitmapItem", methodName : "updateDisplayObject"});
...
nanofl_engine_libraryitems_FontItem.prototype = $extend(nanofl_engine_libraryitems_LibraryItem.prototype,{
	...
	,preload: function() {
		var _gthis = this;
		stdlib_Debug.assert(this.library != null,"You need to add item '" + this.namePath + "' to the library before preload call.",{ fileName : "FontItem.hx", lineNumber : 124, className : "nanofl.engine.libraryitems.FontItem", methodName : "preload"});
		...
		while(_g < _g1.length) {
			var variant = [_g1[_g]];
			++_g;
			r = r.then((function(variant1) {
				return function(_) {
					return _gthis.getExistsSupportedFormat(variant1[0]).then((function(variant2) {
						return function(format) {
							if(format != null) {
								var _this = variant2[0].urls;
								var font = __map_reserved[format] != null ? _this.getReserved(format) : _this.h[format];
								var font1 = new FontFace(family,"url(" + font + ") format(\"" + format + "\")",{ style : variant2[0].style, weight : Std.string(variant2[0].weight)});
								return new Promise((function(variant3) {
									return function(resolve,reject) {
										font1.load().then((function() {
											...
											return function(e) {
												var _this1 = variant4[0].urls;
												haxe_Log.trace("Font '" + family + "' loading error ('" + (__map_reserved[format] != null ? _this1.getReserved(format) : _this1.h[format]) + "'):",{ fileName : "FontItem.hx", lineNumber : 152, className : "nanofl.engine.libraryitems.FontItem", methodName : "preload"});
												haxe_Log.trace(e,{ fileName : "FontItem.hx", lineNumber : 153, className : "nanofl.engine.libraryitems.FontItem", methodName : "preload"});
												resolve(null);
											};
										})(variant3));
									};
								...
								haxe_Log.trace("Can't found suitable font file format ('" + family + " " + variant2[0].style + " " + variant2[0].weight + "').",{ fileName : "FontItem.hx", lineNumber : 161, className : "nanofl.engine.libraryitems.FontItem", methodName : "preload"});
								return null;
							}
						};
					})(variant1));
	...
	,getExistsSupportedFormat: function(variant) {
		return new Promise(function(resolve,reject) {
			js_npm_DrFontSupport(function(supports) {
				var tmp;
				if(supports.woff2) {
...
nanofl_engine_libraryitems_InstancableItem3D.prototype = $extend(nanofl_engine_base_BaseInstancableItem.prototype,{
	...
	,createDisplayObject: function(initFrameIndex,childFrameIndexes) {
		if(this.linkedClass != "") {
			...
			haxe_Log.trace("Linkage class '" + this.linkedClass + "' is not found.",{ fileName : "InstancableItem3D.hx", lineNumber : 28, className : "nanofl.engine.libraryitems.InstancableItem3D", methodName : "createDisplayObject"});
		}
		return null;
	}
	,updateDisplayObject: function(dispObj,childFrameIndexes) {
		stdlib_Debug.methodMustBeOverriden(this,{ fileName : "InstancableItem3D.hx", lineNumber : 34, className : "nanofl.engine.libraryitems.InstancableItem3D", methodName : "updateDisplayObject"});
	}
...
nanofl_engine_libraryitems_MeshItem3D.parseImages = function(namePath,json) {
	nanofl_engine_libraryitems_MeshItem3D.log("parseImages " + namePath,{ fileName : "MeshItem3D.hx", lineNumber : 140, className : "nanofl.engine.libraryitems.MeshItem3D", methodName : "parseImages"});
	nanofl_engine_libraryitems_MeshItem3D.log(json.images,{ fileName : "MeshItem3D.hx", lineNumber : 141, className : "nanofl.engine.libraryitems.MeshItem3D", methodName : "parseImages"});
	var r = [];
	if(json.images != null) {
		var _g = 0;
		var _g1 = json.images;
		while(_g < _g1.length) {
			...
			nanofl_engine_libraryitems_MeshItem3D.log("path = " + path,{ fileName : "MeshItem3D.hx", lineNumber : 149, className : "nanofl.engine.libraryitems.MeshItem3D", methodName : "parseImages"});
			r.push(path);
		}
	}
	return r;
...
nanofl_engine_libraryitems_MeshItem3D.prototype = $extend(nanofl_engine_libraryitems_InstancableItem3D.prototype,{
	...
	,preload: function() {
		var _gthis = this;
		stdlib_Debug.assert(this.library != null,"You need to add item '" + this.namePath + "' to the library before preload call.",{ fileName : "MeshItem3D.hx", lineNumber : 229, className : "nanofl.engine.libraryitems.MeshItem3D", methodName : "preload"});
		return nanofl_engine_Loader.file(this.getUrl()).then(function(s) {
			...
			if(_g == "json") {
				...
				if(json.object != null) {
					...
					if(_gthis.object3D.type == "Mesh") {
						nanofl_engine_libraryitems_MeshItem3D.log("THIS IS NOT A MESH (namePath = " + _gthis.namePath + "; type = " + _gthis.object3D.type + ")",{ fileName : "MeshItem3D.hx", lineNumber : 269, className : "nanofl.engine.libraryitems.MeshItem3D", methodName : "preload"});
					}
				} else {
				...
				if(_gthis.textureFiles.length > 0) {
					return stdlib_Timer.delayAsync(1).then(function(_) {
						return new Promise(function(resolve,reject) {
							nanofl_engine_Loader.queued(_gthis.textureFiles.map(function(_1) {
								return _gthis.library.realUrl(_1);
							}),nanofl_engine_Loader.image).then(function(_2) {
								resolve(null);
							});
						});
					});
				...
				stdlib_Debug.assert(false,"Unknow Mesh file extension ('" + _gthis.ext + "').",{ fileName : "MeshItem3D.hx", lineNumber : 312, className : "nanofl.engine.libraryitems.MeshItem3D", methodName : "preload"});
				return null;
			}
		});
	}
	,updateBoundingRadius: function() {
		...
		this.object3D.traverse(function(object) {
			nanofl_engine_libraryitems_MeshItem3D.log("MeshItem3D.updateBoundingRadius object " + object.type + " / " + object.name,{ fileName : "MeshItem3D.hx", lineNumber : 324, className : "nanofl.engine.libraryitems.MeshItem3D", methodName : "updateBoundingRadius"});
			if(object.type == "Mesh") {
				var mesh = object;
		...
		nanofl_engine_libraryitems_MeshItem3D.log("MeshItem3D.updateBoundingRadius boundingRadius = " + this.boundingRadius,{ fileName : "MeshItem3D.hx", lineNumber : 345, className : "nanofl.engine.libraryitems.MeshItem3D", methodName : "updateBoundingRadius"});
	}
	,createDisplayObject: function(initFrameIndex,childFrameIndexes) {
		return this.object3D.clone();
	}
	,updateDisplayObject: function(dispObj,childFrameIndexes) {
		stdlib_Debug.assert(js_Boot.__instanceof(dispObj,THREE.Object3D),null,{ fileName : "MeshItem3D.hx", lineNumber : 355, className : "nanofl.engine.libraryitems.MeshItem3D", methodName : "updateDisplayObject"});
		var mesh = dispObj;
	}
	,getDisplayObjectClassName: function() {
...
nanofl_engine_libraryitems_MovieClipItem2D.prototype = $extend(nanofl_engine_libraryitems_InstancableItem2D.prototype,{
	...
	,updateDisplayObject: function(dispObj,childFrameIndexes) {
		if(!this.exportAsSpriteSheet) {
			stdlib_Debug.assert(js_Boot.__instanceof(dispObj,nanofl_MovieClip),null,{ fileName : "MovieClipItem2D.hx", lineNumber : 194, className : "nanofl.engine.libraryitems.MovieClipItem2D", methodName : "updateDisplayObject"});
...
var stdlib_Timer = function(time_ms) {
	haxe_Timer.call(this,time_ms);
};
$hxClasses["stdlib.Timer"] = stdlib_Timer;
stdlib_Timer.__name__ = ["stdlib","Timer"];
stdlib_Timer.delayAsync = function(milliseconds) {
...
stdlib_Timer.delay = function(f,time_ms) {
	return haxe_Timer.delay(f,time_ms);
};
stdlib_Timer.measure = function(f,pos) {
	return haxe_Timer.measure(f,pos);
};
stdlib_Timer.stamp = function() {
	return new Date().getTime() / 1000;
};
stdlib_Timer.__super__ = haxe_Timer;
stdlib_Timer.prototype = $extend(haxe_Timer.prototype,{
	__class__: stdlib_Timer
});
...
})( true ? exports : typeof window != "undefined" ? window : typeof self != "undefined" ? self : this, typeof window != "undefined" ? window : typeof global != "undefined" ? global : typeof self != "undefined" ? self : this);
...
var __WEBPACK_AMD_DEFINE_RESULT__;(function (global, define) {
	"use strict";
